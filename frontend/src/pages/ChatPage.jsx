  ...
  return (
    <Box position={"absolute"} left={"50%"} w={{base:"100%",md:"80%", lg:"750px"}} transform={"translateX(-50%)"} p={4}>
        ...
        <Flex gap={4} flexDirection={{base:"column",md:"row"}}  maxW={{sm:"400px",md:"full",}} mx={"auto"}>
            ...
            <Flex border={"1px solid white"} borderRadius={5} flex={30} gap={2} flexDirection={"column"}  maxW={{sm:"250px",md:"full"}} mx={"auto"}>
              ...
              {false && 
              [0,1,2,3,4].map((_,i)=>(
                <Flex  border={"1px solid red"} key={i} gap={4} alignItems={"center"} p={"1"} borderRadius={"md"} >
                   <Box>
                    <SkeletonCircle size={"10"} />
                   </Box>
                   <Flex  bow={"full"} flexDirection={"column"} gap={3}>
           ...
           {/* <Flex flex={70} borderRadius={"md"} p={2} flexDir={"column"} alignItems={"center"} justifyContent={"center"} height={"400px"}>
            ...
            {/* <Flex border={"1px solid red"} flex={70} p={2}>MessageContainer</Flex> */}
            <MessageContainer/>
        </Flex>
    </Box>
  )
